...
import contactoImage from '../assets/rest1.jpg'; // Asegúrate de que la ruta apunte a la foto del restaurante
            ...
            <section className="bg-white mt-16 py-16">
                <div className="container mx-auto px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-4xl font-playfair">VISÍTANOS</h2>
            ...
            <section className="bg-yellow-50 py-16">
                <div className="container mx-auto px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-start">
                    ...
                    <img
                            ...
                            className="w-full rounded-lg mb-32 shadow-lg"
                        />
                    </div>

                    {/* Formulario de contacto */}
                    <div className="space-y-6">
                        <h2 className="text-4xl font-playfair">CONTÁCTANOS</h2>
                        <p className="text-gray-700 leading-relaxed">
                  ...
                  He leído y acepto la{' '}
                    ...
                    Política de Privacidad
                            ...
                            <button
                                type="submit"
                                className="w-full py-4 bg-yellow-500 text-white font-semibold uppercase rounded-lg hover:bg-yellow-600 transition-colors duration-300"
                            >
                                CONTACTA
                            </button>
